...
if __name__ == '__main__':
    ...
    prs.add_argument("--interval_width", dest="interval_width", type=int)
    prs.add_argument("--save_path", dest="save_path", type=str, default="src/exp_6.6_to_6.27/models/fasterrisk")
    ...
    joblib.dump(binarizer, f'{args.save_path}/fasterrisk-{args.group_sparsity}-binarizer')
    print(f"Binarizer saved as {args.save_path}/fasterrisk-{args.group_sparsity}-binarizer")
    ...
    mmp.evaluate.train_evaluate_model(
        ...
        save_path=f'{args.save_path}/fasterrisk-{args.group_sparsity}', card_path=f'{args.save_path}/fasterrisk-{args.group_sparsity}',
